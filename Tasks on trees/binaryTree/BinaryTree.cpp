...
// Задача 7: Да се напише функция, която приема двоично дърво, чиито елементи са символи, и цяло число k 
// и връща думата на к-тото ниво на дървото.
...
// Задача 10: Напишете функция, която приема двоично дърво и обхожда елементите му по следния начин: ляво - корен - дясно (Inorder Traversal).
template<typename T>
...
// Задача 15: Напишете функция, която приема указател към корена на дърво и променя дървото в неговата огледална форма.
template <typename T>
